...
class StlPov extends Convert {
	 ...
	 */
	protected function parseBinary($handle, int $bufferSize): bool
	{
	 ...
	 * @return bool True if able to parse the STL file, false otherwise
	 */
	protected function parseTxt($handle, int $bufferSize): bool
	{
	 ...
	 * @return void
	 */
	protected function writeTriangle (array $t, $handle, string $fn, int $bufferSize): void
	{
	 ...
	 */
	protected function generatePov(array $tplVars): string
	{
		$options = $this->Render3d->options();

		$defaultLayoutFile = $this->Render3d->sceneDir() . 'Pov/layout.php';

		$layoutTemplate = empty($options['PovLayoutTemplate'])
			? $defaultLayoutFile
			: $options['PovLayoutTemplate'];
	 ...
	 * @return void
	 */
	protected function parseCords (array $triangle): void
	{
